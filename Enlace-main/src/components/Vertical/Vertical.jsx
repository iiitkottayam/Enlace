  ...
  return (
    <div className={styles.VerticalWrapper}>
      <Nav />
        ...
        <div className="w-11/12 h-4/6 mx-auto flex flex-col flex-nowrap justify-around text-center items-center pt-16 lg:pt-32 lg:items-start lg:text-left md:text-left  md:h-3/6 md:pt-16 md:items-start">
          <h2 className="text-4xl text-white lg:text-5xl">Welcome to Enlace!</h2>
          <p className="w-11/12 pb-24 pt-12 lg:w-6/12 text-white text-2xl lg:py-12">Lorem ipsum dolor sit amet consectetur adipisicing elit. Impedit veniam fugit omnis pariatur porro, ipsum molestias velit aperiam suscipit accusamus quos corporis, reiciendis tempore dicta?</p>
          <RegisterButton />
        </div>
