const FAQbox = ({ question, answer }) => {
  return (
    <div className="m-5 p-0.5 lg:w-96 lg:h-40 bg-gradient-to-r from-gradient-start/60 to-gradient-stop/60 rounded-xl box-border">
      <div className="p-5 w-full h-full bg-white/60 rounded-xl">
