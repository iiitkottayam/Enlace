...
const Eventteaser = ({ title, image, path }) => {
	return (
		<Link
			to={path + "#"}
			data-aos="zoom-out"
			className="m-10 p-2 bg-gradient-to-r from-gradient-start to-gradient-stop rounded-xl flex flex-col flex-nowrap justify-center items-center h-full"
		>
			<img
				src={image}
				alt="event poster"
			...
			></img>
			<p className="w-64 font-poppins font-medium text-xl text-center">
				{title}
			</p>
		</Link>
	);
